    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Halo Admin : <?php echo $_SESSION['usernameAdmin'] ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                  ...
                  <li >
                      <a href="index.php?iklan" ><i class="fa fa-fw fa-table"></i> Data Iklan</a>
                  </li>
									<li class="active">
                      <a href="index.php?member" ><i class="fa fa-fw fa-table"></i> Data Member</a>
                  </li>
									<li>
										<a href='index.php?logout'><i class="fa fa-fw fa-logout"></i> Logout</a>
                  </li>
                  <!-- <li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
															<thead>
																...
																<tbody>
																	<?php while($row = $this->modelAdmin->fetch($member)){
																		echo "
																			<tr>
																				<td>$row[0]</td>
																				<td>$row[1]</td>
																				...
																				<td>$row[4]</td>
																				<td>$row[5]</td>
                                        <td><a href='index.php?dm=$row[0]' onClick=\"return confirm('Hapus Member ini beserta iklannya?')\"\><button class=\"btn-danger\"> Hapus</button></a></td>
																				</tr>";
																	}
																?>
															</tbody>
